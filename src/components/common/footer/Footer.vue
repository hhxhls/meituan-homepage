      ...
      <div class="info-list">
        ...
        <div class="info-col">
          <dl class="cate-list">
            ...
            <dd>
              外卖消费者：
              <a href="tel:10109777">10109777</a>
            </dd>
            <dd>
              猫眼消费者：
              <a href="tel:10105335">10105335</a>
            </dd>
            <dd>
              其他消费者：
              <a href="tel:10107888">10107888</a>
            </dd>
          </dl>
          <dl class="cate-list">
            <dt>商家服务热线</dt>
            <dd>外卖&餐饮商家：<a href="tel:10105557">10105557</a> </dd>
            <dd>
              休闲娱乐、丽人、ktv、教育、结婚、亲子、家装等商家：
              <a href="tel:10100107">10100107</a>
            </dd>
          </dl>
          <dl class="cate-list">
            <dt>投诉举报热线</dt>
            <dd>
              违法和不良信息举报电话：
              <a href="tel:4006018900">4006018900</a>
            </dd>
            <dd>
              举报邮箱：
              <a href="mailto:tousujubao@meituan.com">tousujubao@meituan.com</a>
            </dd>
          </dl>
          <dl class="cate-list">
            <a href="javascript:void">商家自助入驻美团入口</a>
          </dl>
        </div>
      </div>
      <div class="license">
        ...
        <div class="license-shotcut">
          <p class="text">
            <a href>京公网安备11010502025545号</a>
          </p>
          <p>
            <a href title="备案信息" class="registration license-show">备案信息</a>
            <a href title="备案信息" class="trust-worthy license-show">可信网站认证</a>
            <a href title="12315消费争议" class="customer license-show">12315消费争议</a>
          </p>
        </div>
      </div>
    </div>
